  ...
  stamps: [
    {
      ...
      detail: 'GCI-0 baseline: free EF SET + situational quiz + video task · Triam Udom × AIESEC Chula',
      date: '14 NOV 2025',
      color: 'sky',
      icon: '⚡',
      evidence: 'EF SET C1 certificate · GCI-0 = 42 (L2)',
    },
    {
      stage: 'IMMERSE',
      title: 'EF London — 8 weeks',
      detail: 'Language Abroad · behaviours observed on the GCI rubric by EF staff',
      date: 'MAR – MAY 2026',
      color: 'navy',
      icon: '✈',
      evidence: 'GCI observation log (rubric) · attendance 96%',
    },
    {
      stage: 'APPLY',
